...
if (!isset($_SESSION['Username'])) {
  ...
  $sql = "INSERT INTO shoplist (ShopName, ShopCode, ShopOwner, ShopLocation, ShopPostalCode, ShopLogo, Year) VALUES (?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $sql);
  mysqli_stmt_bind_param($stmt, "sssssss", $shopname, $shopcodefixed, $shopowner, $shoplocation, $shopostalcode, $shoplogo, $time);
...
<head>
  ...
  <meta http-equiv="refresh" content="5; URL='../Code/Dashboard.php'">
